...
betterThanBefore.setups([
  function () {
    ...
    gitDummyCommit(['perf(PROD-133): make it faster', ' closes #1, #2, PROD-3']);
    gitDummyCommit('revert(PROD-133): bad commit');
  ...
  function () {
    gitDummyCommit(['feat(awesome): addresses the issue brought up in PROD-133']);
  },
]);

describe('Vendys preset', function () {
  it('should work if there is no semver tag', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        ...
        expect(chunk).to.include(', closes [PROD-133](https://github.com/vendys/vendys-guidelines/issues/133) [#1](https://github.com/vendys/vendys-guidelines/issues/1) [#2](https://github.com/vendys/vendys-guidelines/issues/2) [PROD-3](https://github.com/vendys/vendys-guidelines/issues/3)');
  ...
  it('should replace #[0-9]+ with GitHub issue URL', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        chunk = chunk.toString();
        expect(chunk).to.include('[#133](https://github.com/vendys/vendys-guidelines/issues/133)');
        done();
      }));
  });
  ...
  it('should remove the issues that already appear in the subject', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        chunk = chunk.toString();
        expect(chunk).to.include('[#88](https://github.com/vendys/vendys-guidelines/issues/88)');
        expect(chunk).to.not.include('closes [#88](https://github.com/vendys/vendys-guidelines/issues/88)');
        done();
      }));
  });
  ...
  it('should fallback to the closest package.json when not providing a location for a package.json', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk, enc, cb) {
        ...
        expect(chunk).to.include('(https://github.com/vendys/vendys-guidelines/compare');
        expect(chunk).to.include('](https://github.com/vendys/vendys-guidelines/commit/');
        expect(chunk).to.include('](https://github.com/vendys/vendys-guidelines/issues/');
  ...
  it('should replace PROD-[0-9]+ with GitHub issue URL', function (done) {
    preparing(9);
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        chunk = chunk.toString();
        expect(chunk).to.include('[PROD-133](https://github.com/vendys/vendys-guidelines/issues/133)');
        done();
      }));
  });
});
